...
// Configuración de la base de datos con variables de entorno de Railway
...
if (!$servername || !$username || !$password || !$dbname) {
    echo json_encode([
        ...
        "message" => "Faltan variables de entorno de Railway. 
                      Asegúrate de haber configurado MYSQLHOST, MYSQLUSER, MYSQLPASSWORD, MYSQL_DATABASE y MYSQLPORT."
    ]);
    exit;
}
...
if ($action === 'buscar') {
    ...
    if (empty($numero_control) || strlen($numero_control) != 8) $errors[] = "Número de control inválido (debe tener 8 caracteres)";
